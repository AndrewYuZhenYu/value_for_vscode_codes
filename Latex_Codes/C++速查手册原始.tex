...
\usepackage[a4paper, left=0.7cm, right=0.7cm, top=1.0cm, bottom=1.0cm, includehead]{geometry}
\usepackage{xeCJK}
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{xcolor}
...
\titlespacing*{\section}{0pt}{0.8ex plus .1ex}{0.3ex plus .1ex}
\titlespacing*{\subsection}{0pt}{0.6ex plus .1ex}{0.2ex plus .1ex}
\titlespacing*{\subsubsection}{0pt}{0.6ex plus .1ex}{0.2ex plus .1ex}
