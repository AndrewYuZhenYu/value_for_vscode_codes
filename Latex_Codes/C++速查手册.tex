...
% 调整了top和bottom留出页眉页脚的空间，防止页码被截断
\usepackage[a4paper, left=1cm, right=1cm, top=1.5cm, bottom=1.5cm, includehead]{geometry}
\usepackage{xeCJK}
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{xcolor}
...
% 紧凑的标题间距设置
\titlespacing*{\section}{0pt}{1.2ex plus .2ex}{0.5ex plus .2ex}
\titlespacing*{\subsection}{0pt}{1ex plus .2ex}{0.5ex plus .2ex}
\titlespacing*{\subsubsection}{0pt}{1ex plus .2ex}{0.5ex plus .2ex}
...
\setcounter{page}{1}  % 强制目录从第 I 页开始算
\setcounter{tocdepth}{2} % 目录显示到 subsection 级别

\tableofcontents % 生成目录（只需调用一次即可）
